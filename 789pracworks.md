Вот файл README.md с решением всех трёх лабораторных работ:
...
Просто скопируйте всё содержимое этого сообщения и сохраните в файл `README.md`. В документе собраны все три лабораторные работы с кодом, функции названы `task1`, `task2` и т.д., комментарии в разговорном стиле.
```